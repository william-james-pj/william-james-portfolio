    ...
    <Container>
      <HomeContainer>
        <HomeContent>
          ...
          <HomeImg>
            <HomeBlob viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <HomeData>
            ...
            <HomeSubTitle>Desenvolvedor full stack</HomeSubTitle>
            <HomeDescription>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. In
              convallis purus quis mauris condimentum molest
            </HomeDescription>
          </HomeData>
        </HomeContent>
        <HomeScroll>
